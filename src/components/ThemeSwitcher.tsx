...
export function ThemeSwitcher() {
  ...
  return (
    <button
      ...
      type="button"
      className="w-10 h-10 p-3 transition bg-gray-200 rounded-full dark:bg-gray-800 hover:bg-nightBlue dark:hover:bg-rose-700 hover:text-white dark:hover:text-gray-800"
