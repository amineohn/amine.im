    ...
    <>
      <FadeIn>
        {doing?.listening_to_spotify ? (
          <>
            <div className="flex flex-row-reverse w-full mb-3 space-x-2 overflow-auto sm:flex-row sm:space-x-2">
          ...
          <>
            <div className="flex flex-row-reverse w-full mb-3 space-x-0 sm:flex-row sm:space-x-2">
              ...
              <div className="inline-flex flex-col w-full max-w-full truncate sm:flex-row">
                <p className="font-medium text-gray-800 text-md dark:text-gray-200">
