      ...
      <form onSubmit={onSubmit}>
        ...
        <div className="inline-flex items-center justify-center mb-1">
          <m.button
            ...
            className="inline-block px-8 py-4 m-0 font-semibold leading-none text-white transition bg-pink-400 rounded-md shadow hover:bg-pink-500 dark:bg-purple-400 dark:hover:bg-purple-500"
          >
            <svg
              width="20"
              height="20"
              viewBox="0 0 80 80"
              className="inline text-white mb-0.5 ml-1"
              fill="none"
