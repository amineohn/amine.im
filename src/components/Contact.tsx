        ...
        <div className="flex mb-4 -mx-2">
          <div className="w-1/2 px-2">
            <input
              ...
              className="block w-full px-4 py-3 leading-tight text-gray-700 transition duration-200 border border-gray-200 rounded appearance-none dark:text-white focus:bg-white focus:border-nightBlue dark:focus:border-rose-400 focus:outline-none dark:bg-gray-900 dark:focus:bg-gray-900 dark:placeholder-white"
              type="email"
              placeholder="Email"
            />
          </div>
