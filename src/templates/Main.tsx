...
const Main = (props: IMainProps) => {
  ...
  return (
    <>
      ...
      <div className="sticky top-0 z-50 flex items-center justify-between w-full max-w-4xl p-8 mx-auto my-0 text-gray-900 bg-white dark:bg-black bg-opacity-60 dark:bg-opacity-60 backdrop-filter backdrop-brightness-50 backdrop-blur-sm md:my-8 dark:text-gray-100">
        <ThemeSwitcher />
        <div>
          <a
            onClick={() => router.push("/")}
