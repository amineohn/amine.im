    ...
    <>
      ...
      <div className="sticky top-0 z-50 flex items-center justify-between w-full max-w-4xl p-8 mx-auto my-0 text-gray-900 bg-white dark:bg-gray-900 md:my-8 dark:text-gray-100">
        ...
        <div>
          <a
            onClick={() => router.push("/")}
            className="p-1 font-medium text-gray-900 transition cursor-pointer sm:p-4 sm:pb-1.5 sm:pt-1.5 rounded-full dark:text-gray-100 hover:text-blue-500 dark:hover:text-rose-700"
          >
            Home
          </a>
          <a
          ...
          >
            <svg
              ...
              className="inline mb-1 text-black transition dark:text-white hover:text-blue-500 dark:hover:text-rose-700"
            >
              <path
