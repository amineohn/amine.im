  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col items-start justify-center max-w-2xl mx-auto">
        <h1 className="mb-3 text-3xl font-bold text-transparent bg-clip-text bg-gradient-conic-b from-yellow-500 via-purple-500 to-blue-500 dark:bg-gradient-to-tl dark:from-indigo-300 dark:to-purple-400">
          Repository Github
        </h1>
        <div className="mb-8">
