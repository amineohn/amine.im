...
const Index = () => {
  ...
  if (!repos || repos.length === 0)
    return (
      <div className="fixed top-0 bottom-0 left-0 right-0 z-50 flex flex-col items-center justify-center w-full h-screen overflow-hidden transition-all bg-white opacity-75 dark:bg-gray-900">
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col items-start justify-center max-w-2xl mx-auto">
        <h1 className="mb-3 text-3xl font-bold text-transparent bg-clip-text bg-gradient-conic-b from-yellow-500 via-purple-500 to-blue-500 dark:bg-gradient-conic-b dark:from-rose-900 dark:via-amber-800 dark:to-rose-400">
          Repository Github
        </h1>
        <div className="mb-8">
